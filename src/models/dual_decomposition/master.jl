...
function dual_decomposition_subproblems(pop::POP, relaxation_order::Int64, 
	variable_sets::Vector{Vector{T}}; max_coupling_order::Int64=2*relaxation_order) where T<:Integer 
